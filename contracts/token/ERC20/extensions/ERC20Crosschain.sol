...
/**
 * @dev Extension of {ERC20} that makes it natively cross-chain using the CBC-7786 based {BridgeERC20Core}.
 *
 ...
 * * {ERC20Bridgeable} instances that are bridged using {BridgeCBC7802}.
 *
 * It is mostly equivalent to inheriting from both {ERC20Bridgeable} and {BridgeCBC7802}, and configuring them such
 * that:
